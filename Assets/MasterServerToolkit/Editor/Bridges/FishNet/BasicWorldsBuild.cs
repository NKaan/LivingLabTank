...
namespace MasterServerToolkit.MasterServer.Examples.FishNetworking
{
    public class BasicWorldsBuild
    {
        ...
        {
            string buildFolder = Path.Combine("Builds", "FishNet", "BasicWorlds", "Room");
        ...
        private static void BuildMasterAndSpawnerForWindows()
        {
            ...
            string roomExePath = Path.Combine(Directory.GetCurrentDirectory(), "Builds", "FishNet", "BasicWorlds", "Room", "Room.exe");
