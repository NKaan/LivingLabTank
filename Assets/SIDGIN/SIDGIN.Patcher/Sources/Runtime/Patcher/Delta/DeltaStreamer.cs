namespace SIDGIN.Patcher.Internal.Delta
{
    ...
    class DeltaStreamer
    {
        internal int _streamChunkSize;

        internal DeltaStreamer()
        {
        ...
        internal void Receive(Stream deltaStream, Stream inputStream, Stream outputStream)
        {
        ...
        internal void Send(IEnumerable<IDelta> deltas, Stream inputStream, Stream outputStream)
        {
        ...
        internal static class DeltaStreamConstants
        {
            ...
            internal static byte COPY_BLOCK_START_MARKER = (byte) 'C';
            internal static byte NEW_BLOCK_START_MARKER = (byte) 'N';
