namespace SIDGIN.Patcher.Internal.Delta
{
    ...
    public class DeltaGenerator
    {
        ...
        internal DeltaGenerator(IRollingChecksum checksumProvider, IHashAlgorithm hashProvider)
        {
        ...
        internal IHashAlgorithm HashProvider { get; set; }

        #endregion

        #region Properties, indexers, events and operators: internal

        internal DeltaStatistics Statistics { get; private set; }

        #endregion

        #region Methods: public

        internal IEnumerable<IDelta> GetDeltas(Stream inputStream)
        {
        ...
        internal void Initialize(int blockSize, IEnumerable<HashBlock> blockHashes)
        {
