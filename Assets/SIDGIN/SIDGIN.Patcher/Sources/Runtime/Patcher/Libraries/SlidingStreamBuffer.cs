namespace SIDGIN.Patcher.Internal.Libraries
{
    ...
    class SlidingStreamBuffer
    {
        ...
        internal SlidingStreamBuffer(Stream stream, int window)
            : this(stream, window, window)
        {
        }

        internal SlidingStreamBuffer(Stream stream, int window, int extraBuffer)
        {
        ...
        /// <returns></returns>
        internal byte GetByteAt(int offset)
        {
            if (!_warmupCalled) Warmup();
            // wait for async read, if any, to complete
        ...
        /// </summary>
        /// <returns></returns>
        internal long GetNumBytesAvailable()
        {
        ...
        /// </summary>
        internal void MoveForward(int n)
        {
